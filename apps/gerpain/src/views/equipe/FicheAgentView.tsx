    ...
    <div className="section-stack">
        ...
        <Card title="Rémunération">
          <dl className="fiche-details">
            <div className="fiche-details__row">
              ...
              <dd>
                {agent.baseSalary ? formatXof(agent.baseSalary) : '—'}
              </dd>
            </div>
            <div className="fiche-details__row">
              <dt>Commission (%)</dt>
              ...
              <tbody>
                {activeAssignments.map((row) => (
                  <tr key={row.id}>
                    ...
                    <td className="num">{formatXof(row.commissionPerUnit)} / u</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <Card title="Tournées sur la période">
        {runs.isLoading ? (
          ...
          <p className="settings-form__hint">Aucune tournée sur cette période.</p>
        ) : (
          <div className="table-wrap">
            <table className="data-table">
              <thead>
              ...
              <tbody>
                {runs.data?.map((run) => (
                  <tr key={run.id}>
                    ...
                    <td className="num">{formatXof(runRevenue(run.items))}</td>
                  </tr>
                ))}
              </tbody>
            </table>
